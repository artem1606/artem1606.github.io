...
$(function(){
	...
	$(window).bind('scroll', function(){
		...
		if(windowTop > infoTop){
			$('.map').html('<script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A245f7106dd2f2018d9f75d7433943e5dab13a49adc2c8e02f5a87eb3708008cb&amp;width=100%25&amp;height=507&amp;lang=ru_UA&amp;scroll=false"></script>');
	...
	$('.circle').each(function(){
		...
		const radius = $(this).find('.progress__ring-circle').attr('r');
		...
		$(this).find('.value span').text(val);
	
		

	});

	const cards = document.querySelectorAll('.our_teamwork_card');
	...
	function startRotate(event){
		const cardItem = this.querySelector('.our_teamwork_photo');
