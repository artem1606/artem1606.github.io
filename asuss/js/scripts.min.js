...
$(function(){
	...
	$('#vd').hover(function(){
		$(this).attr('src', 'img/video-play-bl.png');},
		function(){
...
// Слайдер в шапке сайта	 
	...
	var videoA = function () {this.innerHTML = '<iframe  src="https://www.youtube.com/embed/jqOivnl6KVA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'}; 
	document.querySelector('.video-center').addEventListener('click', function (e) { this.removeEventListener('click', videoA, false); videoA.apply(this, arguments); } , false);
	// воспроизвидение видео
	...
	$('.hamburger').click(function(){
		$('.hidden__menu').toggleClass('visible__menu');
		$('.hamburger').toggleClass('is-active');
	});
	$(window).resize(function(){
		if($(window).width() > 560){
			$('.hidden__menu').removeClass('visible__menu');
...
// скролинг страницы
// назначение активеного класса элементам меню
...
$(window).scroll(function(){
	if($(this).scrollTop() < 20){
		$('.fa').css("margin-left", "200px" );	
		$('.fa').css({opacity:0}, 'slow');	
	
				
	}else{
		$('.fa').css("margin-left", "0" );
		$('.fa').css({opacity:1}, 1000);	
	}	
	if($(this).scrollTop() > $('.header').height()){
		$('.header__menu').addClass('absolute');
		$('.top__menu li').not($('.top__menu li').first()).removeClass('active');
		$('.top__menu li').first().addClass('active');						
	}else{
		$('.header__menu').removeClass('absolute');	
	}	

	});
	$('.top-arrow').click(function(){
		$('html, boby').animate({scrollTop: 0}, 1000);
	})// кнопка наверх
	...
	function showMap(){		
		$('.map').html('<iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d194531.98523426102!2d121.4763530397163!3d25.04530209507461!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sru!2sua!4v1564870774750!5m2!1sru!2sua" style="width:100%; height:570px; border:0" allowfullscreen></iframe>');			
	}
